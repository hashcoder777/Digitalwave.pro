...
#include "Protobuff/profile_info_changer.h"
#include "Protobuff/inventory_changer.h"
#include <windows.h>
#include <string>
#include "../../Menu/Menu.h"
...
{
	if (messageType == k_EMsgGCCStrike15_v2_MatchmakingGC2ClientHello && g_Menu.Config.RankChangerenabled)
	{
